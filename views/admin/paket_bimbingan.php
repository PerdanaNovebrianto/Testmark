                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                PAKET BIMBINGAN
                                <button type="button" class="btn bg-orange waves-effect pull-right" style="margin-top:-6px;" data-toggle="modal" data-target="#tambahBimbingan">TAMBAH PAKET</button>
                            </h2>
                            <div class="modal fade" id="tambahBimbingan" tabindex="-1" role="dialog" data-toggle="modal" data-backdrop="static" data-keyboard="false">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header bg-orange">
                                            <h4 class="modal-title" id="largeModalLabel">TAMBAH KABAR</h4>
                                        </div>
                                        <form id="form_advanced_validation" enctype="multipart/form-data" method="POST" action="<?php echo base_url().'paket_bimbingan/tambah_paket'; ?>">
                                            ...
                                            <div class="modal fade" id="<?php echo 'ubahPaket'.$item_paket->id_paket; ?>"  tabindex="-1" role="dialog" data-toggle="modal" data-backdrop="static" data-keyboard="false">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form id="form_advanced_validation" enctype="multipart/form-data" method="POST" action="<?php echo base_url().'paket_bimbingan/ubah_paket/'.$item_paket->id_paket; ?>">
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    <label class="form-label">Nama Paket</label>
                                                                    <div class="form-line">
                                            ...
                                            <div class="modal fade" id="<?php echo 'hapusPaket'.$item_paket->id_paket; ?>" tabindex="-1" role="dialog">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form id="form_advanced_validation" method="POST" action="<?php echo base_url().'paket_bimbingan/hapus_paket/'.$item_paket->id_paket; ?>">
